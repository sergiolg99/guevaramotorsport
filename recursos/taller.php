  ...
  <header class="sticky-top">
    <nav class="navbar navbar-expand-lg navbar-light h5" style="background-color: white;">
      <div class="container">
        ...
        <a class="navbar-brand justify-content-center" href="../index.html"><img src="./imagenes/logoTransparente.png" class="mobile agrandar" style="width: 110px;" alt="Logo empresa"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item" id="iniciarSesion">
              <a class="nav-link" data-toggle="modal" data-target="#inicioSesion"><i class="fas fa-sign-in-alt"></i>&nbsp;INICIAR SESIÓN</a>
            </li>
          ...
          <a class="navbar-brand" href="carrito.html"><img src="./imagenes/carrito.png" class="mobile agrandar" style="width: 40px;" alt="Imagen carrito"></a>
        </div>
      </div>
    </nav>
  </header>
