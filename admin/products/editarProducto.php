...
/* Consulta SQL para obtener la información de cada producto */
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <form action="" method="POST" id="editarProducto">
                        ...
                        <div class="form-group">
                            ...
                            <img src="getImagen.php?id=<?php echo $fila["id_producto"]; ?>" width="120" height="120" id="imagenProducto" />
    ...
    <script>
        ...
        $("#editarProducto").on("submit", function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "updateProducto.php?id=<?php echo $fila["id_producto"]; ?>",
                type: "POST",
